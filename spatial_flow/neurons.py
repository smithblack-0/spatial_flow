...
The neuron package is where spatial flow gradient based learning actually takes place.
...
class Neurons(keras.layers.Layer):
    """ 
    ...
    def __init__(self, config):
        pass
spatial_register = keras.utils.register_keras_serializable("spatial_flow/neurons")
